...
public class SolutionDao {
    ...
    private static final String FIND_ALL_SOLUTIONS_QUERY_LIMIT_QUERY = "select * from solutions order by id desc limit ?";
    ...
    public Solution[] findRecent(int limit) {
        try (Connection conn = DBUtil.getConnection()) {
            Solution[] solutions = new Solution[0];
            PreparedStatement statement = conn.prepareStatement(FIND_ALL_SOLUTIONS_QUERY_LIMIT_QUERY);
